        ...
        CGPROGRAM
            ...
            fixed4 frag(v2f IN) : SV_Target
            {
                ...
                if (_Outline > 0)
                {
                    ...
                    // new code uses surrounding transparent pixels as outlines, outline size grows externally
                    //added by Chris Garcia (thespinforce@gmail.com)
                    if (_OutlineBorderNotInternal != 0)
                    {
